...
use App\Http\Requests\MyJob\MyJobStoreRequest;
use App\Models\Job;
...
class MyJobController extends Controller
{
     ...
     */
    public function store(MyJobStoreRequest $request)
    {
        $this->authorize('create', Job::class);
     ...
     */
    public function update(MyJobStoreRequest $request, Job $myJob)
    {
        $this->authorize('update', $myJob);
